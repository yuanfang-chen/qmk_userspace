...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_67(
        ...
        KC_LCTL, KC_A,    KC_S,    KC_D,    LT(2,KC_F),    KC_G,    KC_H,    LT(4,KC_J),    KC_K,    KC_L,    KC_SCLN, KC_QUOT,            KC_ENT,           KC_PGDN,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,            KC_GRV, KC_UP,
        KC_CAPS, KC_LOPT, KC_LCMD,                            KC_SPC,                             KC_LAUNCHPAD, KC_HOME, KC_END, KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN1] = LAYOUT_ansi_67(
        ...
        RM_TOGG, RM_NEXT, RM_VALU, RM_HUEU, RM_SATU, RM_SPDU, KC_MISSION_CONTROL, _______, _______, _______, _______, _______,  _______, _______,          _______,
    ...
    [_FN3] = LAYOUT_ansi_67(
        KC_INS,  KC_BRID, KC_BRIU, _______, _______, RM_VALD, RM_VALU, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD,  KC_VOLU, _______,          _______,
        RM_TOGG, RM_NEXT, RM_VALU, RM_HUEU, RM_SATU, RM_SPDU, _______, _______, _______, _______, _______, _______,  _______, _______,          _______,
        _______, RM_PREV, RM_VALD, RM_HUED, RM_SATD, RM_SPDD, _______, _______, _______, _______, _______, _______,           _______,          _______,
        _______,          _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______,           _______, _______,
        _______, _______, _______,                            _______,                            _______, _______,  _______, _______, _______, _______)
